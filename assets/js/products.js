...
const productsCatalog = {
    ...
    frango: [
        {
            id: 'alho-descascado-natural-1kg',
            name: 'Alho Descascado 100% Natural',
            weight: '1kg',
            code: '',
            description: 'ALHO DESCASCADO 100% NATURAL 1KG',
            category: 'Temperos',
            image: 'assets/img/alho-descascado-100-natural-1kg.jpeg'
        },
        {
            id: 'ovos-codorna-conserva-1kg',
            name: 'Ovos de Codorna em Conserva',
            weight: '1kg',
            code: '',
            description: 'OVOS DE CODORNA EM CONSERVA 1KG',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp Image 2025-11-26 at 13.39.41 copy.png'
        },
        {
            id: 'azeitona-conserva-29kg',
            name: 'Azeitona em Conserva',
            weight: '2,9kg',
            code: '',
            description: 'AZEITONA EM CONSERVA 2,9KG',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp Image 2025-11-26 at 13.39.39 (2).png'
        },
        {
            id: 'azeitona-preta-caroco-11kg',
            name: 'Azeitona Preta c/ Caroço',
            weight: '11kg',
            code: '',
            description: 'AZEITONA PRETA C/ CAROÇO 11KG',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp_Image_2025-11-26_at_13.39.40-removebg-preview.png'
        },
        {
            id: 'azeitona-conserva-32kg',
            name: 'Azeitona em Conserva',
            weight: '3,2kg',
            code: '',
            description: 'AZEITONA EM CONSERVA 3,2KG',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp_Image_2025-11-26_at_13.39.39__3_-removebg-preview.png'
        },
        {
            id: 'tomate-seco-2kg',
            name: 'Tomate Seco',
            weight: '2kg',
            code: '',
            description: 'Tomate Seco 2 kg',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp_Image_2025-11-26_at_13.39.40__1_-removebg-preview.png'
        },
        {
            id: 'alho-desidratado-flocos-500g',
            name: 'Alho Desidratado Flocos',
            weight: '500g',
            code: '',
            description: 'ALHO DESIDRATADO FLOCOS 500G',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp_Image_2025-11-26_at_13.39.40__2_-removebg-preview.png'
        },
        {
            id: 'palmito-picado-caixa-6und',
            name: 'Palmito Picado',
            weight: 'Caixa c/ 6und',
            code: '',
            description: 'PALMITO PICADO CAIXA C/ 6UND',
            category: 'Ovos de Codorna',
            image: 'assets/img/WhatsApp_Image_2025-11-26_at_13.39.39-removebg-preview.png'
        }
    ],
    cafe: [
        {
